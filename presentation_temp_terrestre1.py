...
if page == pages [0]:
    ...
    # Créer un graphique d'histogramme avec KDE en utilisant plt.plot
    plt.figure(figsize=(8, 6))
    plt.hist(data, bins=20, density=True, alpha=0.5, color='b', edgecolor='k',  label='Distribution')
    ...
    st.image("Distribution var explicatives 1.png")
    st.image("Distribution var explicatives 2.png")
    ...
    dtree = joblib.load("model_reg_dtree")
